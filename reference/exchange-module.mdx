...
description: "Reference for the addExchangeSchema adapter that registers MongoDB candle data as a backtest-kit exchange source, enabling Pine Script analysis on UZSE data."
---
