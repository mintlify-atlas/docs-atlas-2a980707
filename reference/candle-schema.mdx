---
title: "Candle Schema — candle-items Collection Reference"
sidebarTitle: "Candle Schema"
description: "Mongoose schema and TypeScript types for OHLCV candlestick records, including supported timeframe intervals and the unique composite index."
---
