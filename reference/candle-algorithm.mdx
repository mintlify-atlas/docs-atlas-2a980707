---
title: "Candle Building Algorithm — build-candles.ts Reference"
sidebarTitle: "Candle Algorithm"
description: "Reference for the 5-step OHLCV aggregation algorithm in build-candles.ts: minute bucketing, gap-filling, timeframe rollup, and idempotent inserts."
---
