...
description: "CLI reference for import-trades.ts: parses HTML trade tables from tmp/, deduplicates rows via SHA1 hash, and inserts records into MongoDB trade-results."
---
