---
title: "check-gaps.ts — Trade History Gap Detection Script"
sidebarTitle: "check-gaps"
description: "CLI reference for check-gaps.ts: scans the trade-results collection and reports missing calendar days with Russian day-of-week labels."
---
