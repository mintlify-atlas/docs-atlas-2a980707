---
title: "build-candles.ts — OHLCV Candlestick Builder"
sidebarTitle: "build-candles"
description: "CLI reference for build-candles.ts: aggregates raw trades into OHLCV candles across 11 timeframes with continuous gap-filling. Writes to candle-items collection."
---
