---
title: "download-trades.ts — UZSE Trade Page Scraper"
sidebarTitle: "download-trades"
description: "CLI reference for download-trades.ts: scrapes uzse.uz trade result pages using Playwright and saves HTML files to tmp/. Accepts symbol, date range, and market ID."
---
