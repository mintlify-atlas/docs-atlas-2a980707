---
title: "Docker Services: MongoDB, MinIO, and Redis"
...
<CardGroup cols={3}>
  <Card title="MongoDB" icon="database" href="#mongodb-required">
    Trade and candle storage. Required for all pipeline scripts.
  </Card>
  <Card title="MinIO" icon="box-archive" href="#minio-optional">
    S3-compatible object storage. Used by other backtest-kit components.
  </Card>
  <Card title="Redis" icon="bolt" href="#redis-optional">
